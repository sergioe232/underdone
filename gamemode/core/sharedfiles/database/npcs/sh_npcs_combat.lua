...
NPC = AddDrop(NPC, "money", 30, 1, 500)
...
NPC = AddDrop(NPC, "money", 100, 50, 100)
...
NPC = AddDrop(NPC, "weapon_melee_emptool", 1, nil, nil, 10)
...
NPC = AddDrop(NPC, "money", 100, 30, 43)
